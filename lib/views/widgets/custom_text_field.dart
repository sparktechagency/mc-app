...
class _CustomTextFieldState extends State<CustomTextField> {
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                hintStyle: TextStyle(color: widget.hintextColor ?? AppColors.borderColor, fontSize: widget.hintextSize ?? 12.h,fontWeight: FontWeight.w400),
  ...
  _suffixIcon(IconData icon) {
    return Padding(padding: const EdgeInsets.all(12.0), child: Icon(icon,color:AppColors.borderColor));
  }
